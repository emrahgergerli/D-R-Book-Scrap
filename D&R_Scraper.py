...
total=icerik.find("span",attrs={"id":"searchResultCount"})
...
if ss>1 :
    ...
    for i in range(1,ss):
        ...
        for kitap in kitaps:
                ...
                print(kitap.find("div",attrs={"class":"details"}).h3.text)
                print(kitap.find("span",attrs={"class":"price"}).text)
        print("-"*10,i," .sayfa sonu")
        url2=""
else:
